...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
    ...
    if ((event.body.toLowerCase() == "bot") || (event.body.toLowerCase() == ". বট")) {
     return api.sendMessage("বট বট করছিস কেনো.আমার বস সাইদ এর সাথে প্রেম টেম করবি নাকি..!!🥱😼☠️", threadID);
   };
  
   if ((event.body.toLowerCase() == "Bot") || (event.body.toLowerCase() == "বট")) {
     return api.sendMessage("বট বট না করে আমার বস 'সাইদ' কে একটা গার্লফ্রেন্ড দে..!!❤️‍🩹😼🫣", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "বোকাচোদা") || (event.body.toLowerCase() == "মাদারচোদ")) {
...
হুম")) {
     return api.sendMessage("হুম হুম না করে আমার বস সাইদ এর সাথে প্রেম কর..!!😛🙈💯 ", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "বট তোর বসের নাম কি")) {
     return api.sendMessage("He is Saeid ッ❤️ তাকে সবাই সাইদ নামে  চিনে🤙", threadID);
   };

   if ((event.body.toLowerCase() == "বট তোর বস কে") || (event.body.toLowerCase() == "Bot tor boss ke")) {
     return api.sendMessage("𝐒𝐀𝐄𝐈𝐃 \\____😘😈🩵🪽 ", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "রিপা") || (event.body.toLowerCase() == "মিম")) {
  ...
  if ((event.body.toLowerCase() == "@MD Tamim ") || (event.body.toLowerCase() == "তামিম")) {
     return api.sendMessage("🥰-তামিম-🌺 আমার বস সাইদ এর বন্ধু লাগে লুচ্ছা বেডি'রা দূরে থাক😠🥰⛏️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "moriom") || (event.body.toLowerCase() == "ex")) {
     return api.sendMessage("️ইমন' এটা আমার সাইদ বস এর সালা বাবুর নাম..!!🤣🥰", threadID);
   };
...
না পারলে আমার বস সাইদ কে ডাকিস..!🥱🌝🌚⛏️🌶️ ", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "😒") || (event.body.toLowerCase() == "🙄")) {
     return api.sendMessage("️কিরে  বলদ এইদিকে ওইদিকে কি দেখোস 😆😒😷", threadID);
   };
